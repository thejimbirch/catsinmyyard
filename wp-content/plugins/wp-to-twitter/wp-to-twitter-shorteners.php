...
if ( ! function_exists( 'jd_shorten_link' ) ) { // prep work for future plug-in replacement.
	...
	function jd_expand_yourl( $short_url, $remote ) {
		if ( $remote == 6 ) {
			...
			if ( $token ) {
				$decoded = jd_remote_json( $yourl_api . "?action=expand&shorturl=$short_url&format=json&signature=$token&username=$user&password=$pass" );
			} else {
			...
			<div class="postbox">
				...
				<div class="inside">
					<?php if ( get_option( 'jd_shortener' ) == 7 ) { ?>
						<div class="panel">
							<h4 class="supr">
								<span><?php _e( "Your Su.pr account details", 'wp-to-twitter' ); ?> <?php _e( '(optional)', 'wp-to-twitter' ); ?></span>
							</h4>
					...
					<?php } else if ( get_option( 'jd_shortener' ) == 2 ) { ?>
						<div class="panel">
							<h4 class="bitly">
								<span><?php _e( "Your Bit.ly account details", 'wp-to-twitter' ); ?></span></h4>
					...
					<?php } else if ( get_option( 'jd_shortener' ) == 5 || get_option( 'jd_shortener' ) == 6 ) { ?>
						<div class="panel">
							<h4 class="yourls">
								<span><?php _e( "Your YOURLS account details", 'wp-to-twitter' ); ?></span></h4>
	...
	function wpt_pick_shortener() {
		...
		<p>
			...
			<select name="jd_shortener" id="jd_shortener">
				<option
					value="3" <?php echo jd_checkSelect( 'jd_shortener', '3' ); ?>><?php _e( "Don't shorten URLs.", 'wp-to-twitter' ); ?></option>
				...
				<option
					value="5" <?php echo jd_checkSelect( 'jd_shortener', '5' ); ?>><?php _e( "YOURLS (on this server)", 'wp-to-twitter' ); ?></option>
				<option
					value="6" <?php echo jd_checkSelect( 'jd_shortener', '6' ); ?>><?php _e( "YOURLS (on a remote server)", 'wp-to-twitter' ); ?></option>
				...
				<?php if ( function_exists( 'twitter_link' ) ) { ?>
					<option
					value="9" <?php echo jd_checkSelect( 'jd_shortener', '9' ); ?>><?php _e( "Use Twitter Friendly Links.", 'wp-to-twitter' ); ?></option><?php } ?>
			</select>
		</p>
	<?php
	}
